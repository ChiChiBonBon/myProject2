  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
		 ...
		 <h1>更改密碼</h1>
		 <form action="./Change_pass_1" method="post">
		 	<p>
		 		原密碼：<input type="password" name="orgin_pass_1" required>
		 	</p>
		 	<p>
		 		新密碼：<input id="pass1" type="password" name="new_pass_1" required >
		 	</p>
		 	<p>
		 		確認新密碼：<input id="pass2" type="password" name="che_new_pass_1" required>
		         <br>
