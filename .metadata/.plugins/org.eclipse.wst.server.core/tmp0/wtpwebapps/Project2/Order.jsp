...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <form action="./check_order.jsp" method="Post" onsubmit="return check_form(this.id);">
      ...
      <fieldset name="fieldset">
          <legend></legend>
              ...
              <input type="submit" value="立即下單" class="st_submit" onclick="get_datetime()">
      ...
      <div class="content">
    	  <div class="header">即時查詢</div>   	
      		  <iframe src="select_order.jsp" width="100%" frameborder="0"> id="select_firame"></iframe>
 	 	  </div>
	  </div>
