 ...
 * Generated at: 2021-05-12 10:32:18 UTC
...
public final class register_005f1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<form action=\"./Register_1\" method=\"post\">\n");
      out.write("\t\t\n");
      out.write("\t        <p>\n");
      out.write("\t        \t帳號：<input type=\"text\" name=\"account_1\" required>\n");
      out.write("\t        </p>\n");
      out.write("\t        <p>\n");
      out.write("\t        \t密碼：<input type=\"password\" name=\"password_1\" id=\"pass1\" required>\n");
      out.write("\t        </p>\n");
      out.write("\t        <p>\n");
      out.write("\t        \t密碼確認：<input type=\"password\" name=\"password_2\" id=\"pass2\" required>\n");
      out.write("\t        \t<br>\n");
      out.write("\t\t        <label id=\"isSame\" style=\"color: crimson;\" for=\"\"></label>\n");
      out.write("\t        </p>\n");
      out.write("\t        \n");
      out.write("\t        \n");
      out.write("\t        <p>\n");
      out.write("\t        \t名字：<input type=\"text\" name=\"name_1\" required>\n");
      out.write("\t        </p>\n");
      out.write("\t        \n");
      out.write("\t        <p>\n");
      out.write("\t        \t性別：\n");
      out.write("\t        \n");
      out.write("\t        \t<label for=\"gendermale\">男性</label> <input type=\"radio\"\n");
      out.write("\t        \t\tname=\"gender_1\" id=\"gendermale\" value=\"male\" required>\n");
      out.write("\t        \n");
      out.write("\t        \n");
      out.write("\t        \t<label for=\"genderfemale\">女性</label> <input type=\"radio\"\n");
      out.write("\t        \t\tname=\"gender_1\" id=\"genderfemale\" value=\"female\" required>\n");
      out.write("\t        \n");
      out.write("\t        \n");
      out.write("\t        \t<label for=\"genderother\">其他</label> <input type=\"radio\"\n");
      out.write("\t        \t\tname=\"gender_1\" id=\"genderother\" value=\"other\" required>\n");
      out.write("\t        \n");
      out.write("\t        </p>\n");
      out.write("\t        \n");
      out.write("\t        <p>\n");
      out.write("\t        \t電子信箱：<input type=\"email\" name=\"email_1\" required>\n");
      out.write("\t        </p>\n");
      ...
      out.write("          document.getElementById(\"pass2\").addEventListener(\"keyup\",function(e){\n");
      out.write("              //console.log(\"ketpress\");\n");
      out.write("              let checkString1 = document.getElementById(\"pass1\").value;\n");
      out.write("              let checkString2 = document.getElementById(\"pass2\").value;\n");
      out.write("              let checkSame = document.getElementById(\"isSame\");\n");
      out.write("              \n");
      out.write("              //window.alert(e);\n");
      out.write("              console.log(\"checkString1: \" + checkString1);\n");
      out.write("              console.log(\"checkString2: \" + checkString2);\n");
      out.write("              if(checkString1 === checkString2){\n");
      out.write("                  checkSame.innerHTML=\"密碼相符!\";\n");
      out.write("              }else {\n");
      out.write("                  checkSame.innerHTML=\"密碼不相符!\";\n");
      out.write("              }\n");
      out.write("          });\n");
      out.write("      }\n");
      out.write("  </script>\n");
