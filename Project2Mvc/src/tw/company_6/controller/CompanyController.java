...
//	CompanyService service = new CompanyService(dao);
	...
	@GetMapping(value = "/companyInsertController")
	...
	@DeleteMapping("/companyController/{accNo}")
	public @ResponseBody List<Company_6> delete(@PathVariable String accNo) {
		boolean restuleBean = service.delete(accNo);
		List<Company_6> listAll = service.selectAll();
		return listAll;
	} 
