...
public class Comment_board{
	...
	public Comment_board(){
	}

	public Comment_board(Post_board postboard, Integer comment_num, String userid, String comment,Date ctime,
...
//	}
	...
	public Comment_board(Post_board postboard, Integer comment_num, String userid, String comment,Date ctime,
			Blob cpicture, String cmimeType, String pictureString) {
		super();
		this.postboard = postboard;
		this.comment_num = comment_num;
		this.userid = userid;
	...
	public void setPostboard(Post_board postboard) {
		this.postboard = postboard;
	}
	
	public void setPostboard2(Integer postboard) {
		this.postboard = new FrontPostDaoImpl(). findPostByPost_num(postboard);
	}

	public Post_board getPostboard() {
		return postboard;
	}
...
//	}
	...
	public String getPictureString() {
		return FrontSystemUtils.blobToDataProtocol(cmimeType, cpicture);
	}
