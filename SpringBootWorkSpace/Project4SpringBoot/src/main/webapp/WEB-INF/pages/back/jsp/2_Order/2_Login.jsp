...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="content">
                ...
                <form action="<c:url value = '/admin/authority'/>"  method="Post">
          		<fieldset>
         			 	<legend>管理者登入</legend>
           		<div>
             		<label for="emp_acc">帳號:</label>
            		<input type="text" id="emp_acc" name="emp_acc">
          		</div>
          		<div>
             		<label for="emp_psd">密碼:</label>
            		<input type="text" id="emp_psd" name="emp_psd">
          		</div>
          		</fieldset>
          		<div>
