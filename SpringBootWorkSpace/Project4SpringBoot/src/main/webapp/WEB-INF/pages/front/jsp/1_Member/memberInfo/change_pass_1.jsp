  ...
  <!-- 內容 -->
        <div class="container">
           ...
           <form method="POST" action="change_pass_1">
            ...
            <div class="mb-3">
             <label for="" class="form-label">輸入原密碼</label>
             <input style="width: 500px" type="password" name="orgin_pass_1" class="form-control" id="ori_pass" placeholder="原密碼" required>
            </div>

            <div class="mb-3">
             <label for="password_input" class="form-label">輸入新密碼</label>
             <input style="width: 500px" type="password" name="new_pass_1" class="form-control" id="pass1" placeholder="新密碼" required>
            </div>
            
             <div class="mb-4">
              <label for="password_input" class="form-label">確認新密碼</label>
              <input style="width: 500px" type="password" name="che_new_pass_1" class="form-control" id="pass2" placeholder="再次輸入新密碼" required>
            ...
            <div>
             <button style="width: 250px" class="btn btn-primary" id="commitAndsned" type="submit">更改密碼</button>
            </div>
           ...
           <script>
               ...
               console.log(m);
               let respond_ori_pass = document.getElementById("ori_pass");
               let respond_pass1 = document.getElementById("pass1");
               if (m == "請輸入和新密碼一樣的確認密碼" || m == "輸入錯誤密碼") {
                /* 改變class 和 裡面的文字 */
                   respond_ori_pass.setAttribute("placeholder", m);
                   respond_ori_pass.className = "form-control is-invalid";
                   
                   respond_pass1.setAttribute("placeholder", m);
                   respond_pass1.className = "form-control is-invalid";
          
               } else {
                respond_ori_pass.className = "form-control";
                respond_pass1.classNmae = "form-control";
               }
           </script>
