	    ...
	    <section id="breadcrumbs" class="breadcrumbs">
	      <div class="container">
	        ...
	        <ol>
	          ...
	          <li><a href="<c:url value='/front/history/select' />">歷史紀錄</a></li>
	        </ol>
	        <h2>歷史紀錄</h2>
...
<!-- 分隔線 -->
	 <div class="content"  style="margin:-45px 0px" >
    	 <div class="header">歷史紀錄</div> 
      		 <iframe src="<c:url value='/history/select' />" width="100%" frameborder="0"> id="select_firame"></iframe>
 	 </div>
...
<!-- 分隔線 -->	
	...
	<script type="text/javascript"> 
    	var history_lists = ${history_lists}  ; 
	</script>
	<script type="text/javascript"> 
	...
	<script src="<c:url value='/back/js/History_select.js' />" async defer></script>
	...
	<script type="text/javascript">
		$(function(){
			$('#header_History').addClass('active')
		})
	</script>
