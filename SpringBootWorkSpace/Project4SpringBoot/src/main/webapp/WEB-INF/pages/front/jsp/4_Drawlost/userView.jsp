...
<link href="<c:url value='/front/assets/css/style.css' />"
	rel="stylesheet">
		...
		<div class="card-header py-3 row m-0">
			...
			<div class="card-body">
				<div class="table-responsive">
					<table class="table table-bordered tableArea" id="" width="150%" cellspacing="0">
						<thead>
							<tr>
								<th>股票代碼</th>
								<th>公司名稱</th>
                            ...
                            $(function () {
								...
								function subscribableUrl(){
									...
									for(let i = 0 ; i < subscribeStatusTagCount ; i++){
										...
										document.getElementsByClassName('subscribeStatus')[i].innerHTML = '<center><input type="button" class="btn btn-primary" value="申購"></center>'; 
										}
									}
								}

								document.getElementsByClassName('btn btn-primary')[0].addEventListener('click',buttionStatusChange(this));

								function buttionStatusChange(aaa){
									aaa.removeClass('btn-primary');
									aaa.addClass('btn-success');
									aaa.innerHTML ='取消';
								}
                            });
                        </script>
